...
p1<-matrix(c(0.8,0.9,0.4,0.7,0.2,0.1,0.6,0.3),nrow=c1,ncol=L,byrow=T)
p2<-matrix(c(0.6,0.3,0.8,0.2,0.4,0.7,0.2,0.8),nrow=c1,ncol=L,byrow=T)
p3<-matrix(c(0.1,0.2,0.8,0.3,0.9,0.8,0.2,0.7),nrow=c1,ncol=L,byrow=T)
p4<-matrix(c(0.8,0.7,0.9,0.6,0.2,0.3,0.1,0.4),nrow=c1,ncol=L,byrow=T)
p5<-matrix(c(0.3,0.6,0.8,0.9,0.7,0.4,0.2,0.1),nrow=c1,ncol=L,byrow=T)
p6<-matrix(c(0.2,0.1,0.3,0.4,0.8,0.9,0.7,0.6),nrow=c1,ncol=L,byrow=T)
